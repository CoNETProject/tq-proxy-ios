...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    private func setup(_ completionHandler: @escaping (Error?) -> Void) {
        let settings = NEPacketTunnelNetworkSettings(tunnelRemoteAddress: "104.219.41.232")
        //settings.mtu = 1440
        ...
        //
        let ipv4Settings = NEIPv4Settings(addresses: ["192.168.192.169"], subnetMasks: ["255.255.255.0"])
        ...
        ipv4Settings.excludedRoutes = [
            ...
            NEIPv4Route(destinationAddress: "104.219.41.232", subnetMask: "255.255.255.255"),
            NEIPv4Route(destinationAddress: "198.251.77.20", subnetMask: "255.255.255.255")
        ]
